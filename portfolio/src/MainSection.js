        ...
        return(
            <div className="mainSection">
                ...
                <div className="projects">
                    ...
                    <p className="mainParagraph" >Slackr is a web application and Slack bot that makes standups meetings asynchronous. In this project I display my full stack developer skills by adding to the frontend and backend</p>                   
                ...
                <div className="projects">
                    ...
                    <p className="mainParagraph" >Black-Hole is a web based application that allows users to sign up and vent their emotions anonymously.In BlackHole I was a frontend developer that used CRUD operations to create this web applications functionality</p>
                ...
                <div className="projects">
                    ...
                    <p className="mainParagraph"  >Family Recipes is a web based application that allows users to register and create a list of recipes and categorize them too. In Family Recipes, I created the backend functionality that connected to the my frontend developers code</p>
